...
ASR_DATA_PATH="/n/work6/yizhang/Moris/zoom2025/pretrain_labels/l3_conv_train"
...
LOGGING_STEPS=10
SAVE_TOTAL_LIMIT=5
OUTPUT_DIR=/n/work6/yizhang/Moris/Models/StreamingSpeechLLM/ASR_TS/qwen2audio_pretrainl3_chunk${CHUNK_SECS}s_lora16
