...
class DualChannelConvDataset(Dataset):
    ...
    def _resolve_audio(self, ele: dict) -> list[dict]:
        ...
        for i in range(len(utterances)):
            ...
            t_B_time = [[uttr["start"], uttr["end"]]  for uttr in uttrs if uttr["speaker"] == 'B']
            t_A_time.sort()
            t_B_time.sort()
            ...
            if 'A' in speakers and 'B' in speakers:
                ...
                audio_dict = {
                    "A": {"audio":audio_a_path, "audio_start": t_start, "audio_end": t_end},
                    "B": {"audio":audio_b_path, "audio_start": t_start, "audio_end": t_end},
                    "utterances": uttrs
                }
            elif 'A' in speakers:
                t_A_start, t_A_end = t_A_time[0][0], t_A_time[-1][-1]
